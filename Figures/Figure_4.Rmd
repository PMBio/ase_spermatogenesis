...
# clustering analysis figure4
# Show dynamics of Expression, DE (ASE F0), cis (ASE F1) and trans (ASE F0 - F1) over time as clusters
# Show that main mode or variation is increase in DE, cis and trans late in differentiation
...
data.frame(
  Cluster = factor(1:length(unique(table(joint_sub_total))), levels = c("7", "5", "4", "2", "1", "3", "6")), 
...
plot_df_here <- plot_df[plot_df$Cluster %in% c("Cluster_2", "Cluster_4", "Cluster_5", "Cluster_7"), ]
...
data.frame(
  Cluster = factor(1:length(unique(table(joint_sub_deg))), levels = c("7", "5", "4", "2", "1", "3", "6")), 
...
data.frame(
  Cluster = factor(names(table(joint_sub_cis)), levels = c("7", "5", "4", "2", "1", "3", "6")), 
...
data.frame(
  Cluster = factor(names(table(joint_sub_trans)), levels = c("7", "5", "4", "2", "1", "3", "6")), 
